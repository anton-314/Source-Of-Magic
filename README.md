...
├── world/                # The Documentation (Lore & Worldbuilding)
│   ├── geography/        # Maps, kingdoms, and regions
│   ├── magic-system/     # The rules and mechanics of "The Source"
│   └── characters/       # Character sheets and character arcs
├── manuscript/           # The "Source Code" (The actual book)
│   ├── chapter-01.md
│   ├── chapter-02.md
│   └── chapter-03.md
└── README.md
